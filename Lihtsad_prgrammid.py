...
# b = float(input("\nb = "))
# S = (a*100)/b
# print(f"\nРасход топлива равна {S}")

# #Ulesanne 9 
# keskkiirus=float(500) # м/м, 29,9 км/ч
# print("\nВведите время катания (в минутах!!!!!!!!!!!!!!!!!!!!!!!!!!!!!):")
# M = float(input("Минуты = "))
# S=keskkiirus*M
# S2=S/10006
# print(f"\nВы уехали на = {S2} kiloметров")

# Ülesanne 10

print("\nВведите пж время в минутах)):")
vM = float(input("Минуты = "))
C = round(vM/60)
M = round(vM%60)
print(f"Это будет {C}:{M}")
